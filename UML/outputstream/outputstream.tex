...
\begin{figure}
\centering
\includegraphics[width =1\linewidth]{uml/outputstream/3.png}
...
\begin{figure}[h]
\centering
\includegraphics[width =1\linewidth]{uml/outputstream/write.png}
\caption{HDFS写文件时序图}
