	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=3in,height=3in]{summary.jpg}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=3in,height=3in]{SA/common-io-diagram.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=3in,height=3in]{SA/hdfs-fsinputstream-methods-diagram.png}
		\caption{hdfs-fsinputstream-methods-diagram}
		\label{fig:graph3}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=3in,height=3in]{SA/UML.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=3in,height=3in]{SA/PositionedReadable.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=3in,height=3in]{SA/Seekable.png}
		\caption{Seekable}
		\label{fig:graph6}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=3in,height=3in]{SA/FSInputChecker.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=3in,height=3in]{SA/BufferedFSInputStream.png}
